				...
				if (secondElement.textContent.trim() !== '0 - 0 of 0') {
					try {
						...
						try {
							...
							const elements = document.querySelectorAll(`[data-lp-id="MscrmControls.Grid.ReadOnlyGrid|Component9354386|null|fc09b449-c0b0-ee11-a569-6045bdeb5429|{4143B74E-4A07-4D01-9FFE-2CDCAA4208FD}|incident|cc-grid|cc-grid-cell|cell-${i}-2"]`);
										...
										if (!("Notification" in window)) {
										  ...
										  Notification.requestPermission().then(function(permission) {
											if (permission === "granted") {
											  ...
											  var notification = new Notification("Your CE queue has pending CaseNumber: "+spanText);
